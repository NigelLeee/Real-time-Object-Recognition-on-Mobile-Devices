...
class VideoMode extends StatefulWidget {
  const VideoMode({Key? key}) : super(key: key);

  @override
  VideoModeState createState() => VideoModeState();
}

class VideoModeState extends State<VideoMode> {
